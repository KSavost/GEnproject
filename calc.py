...
def generating(self, num_of_vars):
    test = [2, 3, 4]
    g_arr = [a, o, u, e]
    r9 = random.choice(test)
    r10 = random.choice(test)
    r11 = random.choice(test)
    r12 = random.choice(test)
    ...
    big_arr = [[a, o], [e, u], [s, ss]]
    res9, big_arr  = r9(r9, [[a, o], [e, u], [s, ss]], [0,0,0,0,0])
    res10, big_arr2 = r10(r10, [[tz, mz], [i, bl], [pru, pre], [z, c], [pra, pro]], [0,0,0,0,0])
    res11, big_arr3 = r11(r11,  [[ar1, ar2], [ar3, ar4]], [0,0,0,0,0])
    res12, big_arr3 = r12(r12,  [[ar1, ar2], [ar3, ar4]], [0,0,0,0,0])
    return([res9, res10, res11, res12])
